...
intents = {
    ...
    "help": {
     ...
     "time": {
        ...
        "responses": [f"It's {current_time} .", f"The current time is {current_time} .", f"Right now, it's {current_time}."]
    },
    "date": {
        "patterns": ["what's the date?", "current date", "date please", "what date is it?"],
        "responses": [f"Today's date is {current_date}.", f"The current date is {current_date}.", f"Right now, it's {current_date}."]
    },
    "datetime": {
        "patterns": ["what's the date and time?", "current date and time", "datetime please", "what's the current date and time?"],
        "responses": [f"It's {current_date} and {current_time} .", f"The current date and time is {current_date}, {current_time} .", f"Right now, it's {current_date} and {current_time} ."]
    },
    "jokes": {
...
while True:
    ...
    if intent in intents:
        ...
        speak(f"AI Assistant: Sorry, I'm not sure how to respond to that.")